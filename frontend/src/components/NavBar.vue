  ...
  <nav id="navbar">
    <v-app-bar class="white" flat app clipped-left>
      ...
      <v-toolbar-title class="font-weight-bold"
        ><router-link to="/" class="red--text" style="text-decoration: none"
          >Zavalla</router-link
        ></v-toolbar-title
      >
      <v-spacer></v-spacer>
        ...
        <v-card>
          ...
          <v-list>
            ...
            <v-list-item router to="/studio">
              ...
              <v-list-item-title>Zavalla Studio</v-list-item-title>
            </v-list-item>
        ...
        <v-list dense nav class="py-0" tag="div">
          ...
          >
            <v-app-bar-nav-icon
              ...
              class="mr-5"
            ></v-app-bar-nav-icon>
            <v-toolbar-title class="font-weight-bold">Zavalla</v-toolbar-title>
          </v-list-item>
          ...
          <v-text>
            NOTE: FOR DEMO PURPOSES, EVERYONE IS CURRENTLY ABLE TO UPLOAD CONTENT. IF YOU WISH TO VERIFY YOURSELF AS A PROFESSIONAL, EMAIL TAACHIWI@GMAIL.COM WITH YOUR CREDENTIALS AND YOU WILL RECIEVE A VERIFICATION.
          </v-text>
          <v-divider class="mt-2 mb-2"></v-divider>
          <v-text>
            ADDITIONAL NOTE: IF YOU SEE AN ERROR ON THE MAIN PAGE, IT IS LIKELY BECUASE THE MONGODB DATABASE CURRENTLY HAS A MAJOR BUG (https://jira.mongodb.org/browse/COMPASS-5446) THAT MAKES IT BREAK AFTER A PERIOD OF INACTIVITY. THE TEAM IN CHARGE OF MONGODB IS WORKING ON IT.
          </v-text>
        </v-list>
      </div>
    </v-navigation-drawer>
...
export default {
  data: () => ({
    ...
    links: [
      { text: 'About', link: 'https://github.com/taachiwi/zavalla.md' },
      { text: 'Press', link: 'https://twitter.com/taachiwi' },
      { text: 'Copyrignt', link: 'https://webcache.googleusercontent.com/search?q=cache:PJc1--9DsHgJ:https://www.nibusinessinfo.co.uk/downloads/sample-internet-copyright-notice.doc&cd=19&hl=en&ct=clnk&gl=ca' },
      { text: 'Contact us', link: 'mailto:taachiwi@gmail.com' },
      { text: 'Creators', link: 'https://github.com/taachiwi' },
      { text: 'Developers', link: 'https://github.com/taachiwi' },
      { text: 'Terms', link: 'https://www.fleetster.net/legal/standard-terms-and-conditions.pdf' },
      { text: 'Privacy', link: 'https://www.unltd.org.uk/uploads/general_uploads/DLA-Piper-Privacy-Policy-Template.pdf' },
      { text: 'Policy & Safety', link: 'https://www.icmec.org/wp-content/uploads/2019/11/Sample-online-safety-and-social-media-policy-2017.pdf' },
    ],
    channelLength: 0,
    searchText: '',
    // user: null
